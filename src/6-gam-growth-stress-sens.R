...
#Save results
saveRDS(H1_adj_res_noWgrowth, here("results/sensitivity/H1_adj_res_noWgrowth.RDS"))
...
for(i in 1:nrow(H2_adj_models)){
  ...
  H2_adj_res_noWgrowth <-  bind_rows(H2_adj_res_noWgrowth , preds$res)
}


#Save results
saveRDS(H2_adj_res_noWgrowth, here("results/sensitivity/H2_adj_res_noWgrowth.RDS"))
...
#Save results
saveRDS(H3_res, here("results/sensitivity/H3_adj_res_noWgrowth.RDS"))
...
#Save results
saveRDS(H4_res, here("results/sensitivity/H4_adj_res_noWgrowth.RDS"))
