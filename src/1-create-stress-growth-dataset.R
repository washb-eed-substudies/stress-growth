...
#---------------------------------------------------------------------------------------------
# Update to use harmonized EED dataset, with updated grc transformations
#---------------------------------------------------------------------------------------------

d <- readRDS("C:/Users/andre/Documents//EE/eed-substudy-data/bangladesh-cleaned-master-data.RDS") %>% subset(., select = -c(t3_gcr_cpg12, t3_gcr_mean))
d_grc <- readRDS(paste0(dropboxDir,"Data/Cleaned/Andrew/stress_growth_data.RDS")) %>% select(childid, t3_gcr_cpg12, t3_gcr_mean)
d <- left_join(d, d_grc, by = c("childid"))

saveRDS(d, paste0(dropboxDir,"Data/Cleaned/Andrew/stress_growth_data_clean.RDS"))
...
#     t3_gcr_mean=logit((t3_gcr_mean+0.01)/100), 
#     t3_gcr_cpg12=logit((t3_gcr_cpg12+0.01)/100))
# 
# 
# 
# #Clean inf values
...
# d_hhwealth <- read.csv("C:/Users/andre/Dropbox/WASHB-EE-analysis/WBB-EE-analysis/Data/Cleaned/Audrie/hhwealth.csv")
